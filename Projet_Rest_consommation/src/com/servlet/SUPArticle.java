...
public class SUPArticle extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			URL url = new URL("http://localhost:8080/Site_Rest(Publication)/traitement/SupprimerArticle/"+id);
		...
		List<Article> listArticle = mapper.readValue(fileInputStream1, new TypeReference<List<Article>>(){});
		
		for (Article listeA : listArticle) {
			System.out.println(listeA.getDesc());
		}
