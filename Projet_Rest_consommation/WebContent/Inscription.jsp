        ...
        <div class="main-menu">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand" href="index.html"><img src="C:\Users\hajar\Desktop\img_site\logo2.jpg" alt="logo"></a>
                ...
                <form method="get" action="./inscreption">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            <input name="gmail" type="text" placeholder="Entrez nom@login" required />
                            <span class="required-star">*</span>
                        </div>
