				...
				<nav class="navbar navbar-expand-lg navbar-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							<li class="navbar-item"><a href="/Projet_Rest_consommation/afficherArticle"
								class="nav-link">ARTICLES</a></li>
							<li class="navbar-item"><a href="/Projet_Rest_consommation/afficherClient"
								class="nav-link">CLIENTS</a></li>
							<li class="navbar-item"><a href="/Projet_Rest_consommation/afficherCommande"
								class="nav-link">COMMANDES</a></li>

							<li class="navbar-item active"><a href="/Projet_Rest_consommation/Deconnecter"
...
</div><table  class="table table-striped" style="margin-top:20px;">
<tr><th>Id</th><th>Description</th><th>Prix</th><th>Qantité</th><th>Img</th><th>Option Admin </th></tr>

<c:forEach items="${listeArticle}" var="i">	
	<tr>
	<td>${i.id}</td>
	<td>${i.desc}</td>
	<td>${i.prix}</td>
	...
	<td><a href="/Projet_Rest_consommation/SUPArticle?id=${i.id}">Supprimer</a></td>
	</tr>
</c:forEach>
